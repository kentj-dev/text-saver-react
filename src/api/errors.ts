...
const CUSTOMER_MESSAGES: Record<string, string> = {
  BACKEND_NOT_CONFIGURED:
    "Licensing is not available right now. Please try again later.",
  NETWORK_ERROR:
    "The licensing server could not be reached. Check your connection and try again.",
  LICENSE_DEVICE_LIMIT_EXCEEDED:
    "You've reached your device limit. Deactivate an old device to activate this one.",
  DEVICE_LIMIT_EXCEEDED:
    "You've reached your device limit. Deactivate an old device to activate this one.",
  DEVICE_LIMIT_REACHED:
    "You've reached your device limit. Deactivate an old device to activate this one.",
  TOKEN_FAMILY_REVOKED:
    "Your session has expired. Please activate this device again.",
  REFRESH_TOKEN_REVOKED:
    "Your session has expired. Please activate this device again.",
  INVALID_REFRESH_TOKEN:
    "Your session has expired. Please activate this device again.",
  REFRESH_TOKEN_REUSED:
    "Your session ended because its security token was reused. Please activate this device again.",
  SESSION_REVOKED: "This device has been signed out. Please activate it again.",
  INVALID_ACCESS_TOKEN:
    "Your session has expired. Please activate this device again.",
  DEVICE_REVOKED:
    "This device was deactivated. Activate it again to restore access.",
  LICENSE_REVOKED:
    "This license has been revoked. Contact support if you think this is a mistake.",
  LICENSE_EXPIRED:
    "This license has expired. Renew it to restore Plus features.",
  SUBSCRIPTION_EXPIRED:
    "Your subscription has ended. Renew it to restore Plus features.",
  SUBSCRIPTION_INACTIVE:
    "Your subscription is inactive. Update billing to restore Plus features.",
  ENTITLEMENT_MISSING: "Your plan does not include this feature.",
  DEVICE_NOT_ACTIVATED:
    "This device is no longer activated. Activate it again to restore access.",
  PRODUCT_MISMATCH: "This license is for a different product.",
  INVALID_LICENSE:
    "That license key is not valid. Check the key and try again.",
  ROTATION_REQUIRED:
    "Your session could not be renewed safely. Please activate this device again.",
  SYNC_CONFLICT:
    "Cloud data changed on another device. Text Saver will merge and retry.",
  ...
  CANNOT_REVOKE_CURRENT_DEVICE:
    "Sign out to remove this device from the license.",
};
...
export function customerMessage(code: string, fallback?: string): string {
  return (
    CUSTOMER_MESSAGES[code.toUpperCase()] ||
    fallback ||

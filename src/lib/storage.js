...
export function isValidTab(tab) {
    ...
    return tab.protected === true
        ...
        && (tab.encryptionContextId === undefined || typeof tab.encryptionContextId === 'string');
}
...
export async function encryptText(text, tabId, keyBytes, saltBytes, encryptionContextId = tabId) {
